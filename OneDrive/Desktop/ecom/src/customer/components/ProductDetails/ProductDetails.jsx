        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10 ">
          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 ">
              <h1 className="text-lg lg:xl font-semibold text-gray-900">
                Universaloutfit
              </h1>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">3550 Reviews</p>
            </div>  
              ...
              <form className="mt-10">
                ...
                <h3 className="text-sm font-medium text-gray-900">Size</h3>
                 ...
                 <div className="py-2">
                <Button onClick={handleAddToCart}  variant="contained " sx={{px:"2rem" ,py:"1rem",bgcolor:"Blue", color:"white", }}>
                  Add to Cart
                </Button>
                 </div>
...
<Grid container spacing={2} >
       ...
       <Grid item size={5} >
           ...
           <div className="flex items-center space-x-3">
            ...
            <p className="opacity-60">56884 Ratings</p>
           </div>
        ...
        <section className="pt-10">
           <h1 className="py-5 text-xl font-bold opacity-80">Similar Products</h1>
